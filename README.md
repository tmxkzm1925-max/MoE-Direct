...
| Kimi K3 (2.8T class) | **Due to current disk space limitations, we were unable to obtain the K3 MXFP4, but the Kimi-K3-Q2_K_XL is currently prepared on the disk, and since we are prioritizing improvements to other features, it is not yet ready I will try to find you as soon as possible, beyond format-validated (as of 2026-08-11) |
